...
CREATE INDEX IF NOT EXISTS abpdmodelccategory_idx ON olapts.abpdmodelccategory (factmappdinstanceid_,pkid_);
CREATE INDEX IF NOT EXISTS abpdmodelccategory_idx_idx2 ON olapts.abpdmodelccategory (pkid_,versionid_,sourcepopulateddate_) include(isvisible_,isvalid_,isdeleted_,islatestversion_,createdby_,createddate_,updatedby_,updateddate_,sourcepopulatedby_);	
...
CREATE INDEX IF NOT EXISTS abpdmodelccategoryflag_idx ON olapts.abpdmodelccategoryflag (id_);
...
DO $$
BEGIN
ANALYZE olapts.abaddress;
ANALYZE olapts.abaddressflag ;
ANALYZE olapts.abentityindustry ;
ANALYZE olapts.abentityindustryflag ;
ANALYZE olapts.abentityofficers ;
ANALYZE olapts.abentityofficersflag ;
ANALYZE olapts.abupentity ;
ANALYZE olapts.abupentityflag ;
ANALYZE olapts.abfactentity;
ANALYZE olapts.abfactentityflag ;
ANALYZE olapts.abaddedaccount ;
ANALYZE olapts.abaddedaccountflag ;
ANALYZE olapts.abfinancial ;
ANALYZE olapts.abfinancialflag ;
ANALYZE olapts.abhiststmtbalance ;
ANALYZE olapts.abhiststmtbalanceflag ;
ANALYZE olapts.abhistoricalstatement ;
ANALYZE olapts.abhistoricalstatementflag ;
ANALYZE olapts.abstatementconstant ;	
ANALYZE olapts.abstatementconstantflag ;
ANALYZE olapts.abprojectionstatement ;
ANALYZE olapts.abprojectionstatementflag ;
ANALYZE olapts.abpeeranalysis ;	
ANALYZE olapts.abpeeranalysisflag ;
ANALYZE olapts.abuphiststmtfinancials ;
ANALYZE olapts.abuphiststmtfinancialsflag;
ANALYZE olapts.abupprojection ;
ANALYZE olapts.abupprojectionflag ;
ANALYZE olapts.abupprojstmtfinancials ;
ANALYZE olapts.abupprojstmtfinancialsflag ;
ANALYZE olapts.abupprojstmtfinancialsdetail ;
ANALYZE olapts.abupprojstmtfinancialsdetailflag ;
ANALYZE olapts.abratingoverride ;
ANALYZE olapts.abratingoverrideflag ;
ANALYZE olapts.abentityrating ;
ANALYZE olapts.abentityratingflag ;
ANALYZE olapts.abratingscenario ;
ANALYZE olapts.abratingscenarioflag ;
ANALYZE olapts.abratingscenarioblockdata ;
ANALYZE olapts.abratingscenarioblockdataflag ;
ANALYZE olapts.abmapinstance ;
ANALYZE olapts.abmapinstanceflag ;
ANALYZE olapts.abmodelshippingscorecard ;
ANALYZE olapts.abmodelshippingscorecardflag ;
ANALYZE olapts.abpdmodelccategory ;
ANALYZE olapts.abpdmodelccategoryflag ;
ANALYZE olapts.factratingscenarioblockdatalatest;
ANALYZE olapts.factratingscenario;
ANALYZE olapts.factentity;
ANALYZE olapts.dimentityindustry;
ANALYZE olapts.dimpeeranalysis;
ANALYZE olapts.dimpeeranalysislatest;
ANALYZE olapts.factuphiststmtfinancial;
ANALYZE olapts.factuphiststmtfinancialgift;
ANALYZE olapts.facthiststmtbalancelatest;
ANALYZE olapts.abpdmodelccategory;
ANALYZE olapts.abpdmodelccategoryflag;
ANALYZE olapts.abmodelshippingscorecard;
ANALYZE olapts.abmodelshippingscorecardflag;
