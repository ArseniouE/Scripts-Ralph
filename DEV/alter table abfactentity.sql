...
INSERT INTO olapts.abfactentity(
    ...
    enterprisevaluetototaldebt, expirydate, valuationmethodology, bankruptcy, governmentbailoutoffirm, industrysector, arrearunit, 
    arrearunitval, customercategory, customercategoryval, delaydaysods, delaysoverbalancesratioods, epidikosleasing, epidikosleasingval, 
    idnumberods, industrypeersector, iscustabcfactors, iscustleasing, iscustleasingval, iscustlux, iscustluxval, isnpl, isnplval, 
    isvisible, isvisibleval, iswholesale, iswholesaleval, legalentitytype, legalentitytypeval, marker, monitoringunit, monitoringunitval, 
    nplchanged, nplchangedval, odsinsertdate, odsisupdated, odsupdatedate, offbalancesdwh, onbalancesdwh, totalbalanceods, 
    totaldelaysods, totalexposuresdwh, internationalsyndicationloan, wfid_, taskid_, snapshotid_, contextuserid_, createdby_, createddate_, updatedby_, updateddate_, 
