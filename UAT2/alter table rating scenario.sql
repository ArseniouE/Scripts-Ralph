...
INSERT INTO olapts.abratingscenario(
	factratingscenarioid_, pkid_, ratingscenarioid, versionid_, entityid, 
	originalfinancialcontext, financialcontext, financialid, financialversionid, 
	peeranalysis_version_match, entity_version_match, projection_version_match, 
	stmts_versions_, name, originalgrade, scenariotyperef, amuser, ratingstatus, nextreviewdate, 
	creditcommitteedate, modelid, isprimary, finalgrade, finalscore, modelgrade,
	modelpd, approveddate, mastergrade, statementcount, lateststatementid, 
	overridegrade, overridepd, approveid, approver, islatestapprovedscenario, 
	approvalstatus, configversion, isapproved, modelinputschanged, 
	masteroverridegrade, masteroverridepd, selectedfinancialid, 
	masterpd, modelversion, overlaypd, overlayrating, projectionid, 
	proposedrating, usedfinancial, parentid, parentname, extendedreviewdate,--expirationdate, 
	wfid_, taskid_, snapshotid_, contextuserid_, createdby_, createddate_, updatedby_, 
	updateddate_, isvalid_, isdeleted_, isvisible_, islatestversion_, t_, baseversionid_, 
...
select
	...
	masteroverridegrade, masteroverridepd, selectedfinancialid, 
	masterpd, modelversion, overlaypd, overlayrating, projectionid, 
	proposedrating, usedfinancial, parentid, parentname, extendedreviewdate,
	--expirationdate, 
	wfid_, taskid_, snapshotid_, contextuserid_, createdby_, createddate_, updatedby_, 
	updateddate_, isvalid_, isdeleted_, isvisible_, islatestversion_, t_, baseversionid_, 
	statusid_, sourcepopulatedby_, sourcepopulateddate_
