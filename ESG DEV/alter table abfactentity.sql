...
INSERT INTO olapts.abfactentity(
	factentityid_, pkid_, gc12, gc13, gc16, gc17, gc18, gc19, gc22, gc23, gc100, gc108, gc109, gc110, gc111, 
    gc112, gc113, gc114, gc115, gc116, gc117, taxid, gender, idtype, onlist, cdicode, groupid, currency, division, 
    entityid, firmtype, idnumber, islocked, lockedby, longname, prospect, systemid, shortname, stockcode, moduleid_, 
    currentemp, entitytype, lockeddate, occupation, reviewtype, salutation, dateofbirth, designation, guarantorid, 
    legalentity, listingdate, yearstarted, businesstype, countryofinc, countryofres, creditnumber, descriptions, 
    industrycode, issuecountry, monthstarted, nationality1, nationality2, nationality3, countryofrisk, customersince, 
    stockexchange, yearinservice, connectedparty, lastreviewdate, nextreviewdate, placeoflisting, corporationtype, 
    creditcommittee, creditportfolio, nameofguarantor, restrictedusers, schedreviewdate, countryoflisting, relationshiptype, 
    restrictedentity, businessportfolio, establishmentdate, indclassification, permanentresident, responsibleoffice, 
    ...
    industrysector, internationalsyndicationloan, wfid_, taskid_, snapshotid_, contextuserid_, createdby_, createddate_, updatedby_, 
	updateddate_, isvalid_, baseversionid_, versionid_, isdeleted_, isvisible_, islatestversion_, t_, sourcepopulatedby_, sourcepopulateddate_
)
select
	factentityid_, pkid_, gc12, gc13, gc16, gc17, gc18, gc19, gc22, gc23, gc100, gc108, gc109, gc110, gc111, 
    gc112, gc113, gc114, gc115, gc116, gc117, taxid, gender, idtype, onlist, cdicode, groupid, currency, division, 
    ...
    multiplenationalities, primarybankingofficer, sourcesystemidentifier, consolidatedbalancesheet, provincestateofincorporation,
    enterprisevaluetototaldebt, expirydate, valuationmethodology, jurisdiction, bankruptcy, governmentbailoutoffirm, 
    industrysector, internationalsyndicationloan, wfid_, taskid_, snapshotid_, contextuserid_, createdby_, createddate_, 
	updatedby_, updateddate_, isvalid_, baseversionid_, versionid_, isdeleted_, isvisible_, islatestversion_, t_, sourcepopulatedby_, sourcepopulateddate_
from olapts.abfactentity_backup;
	...
	--CHECK DATA--------------------------------
	--=================================================
	--select * from olapts.abfactentity limit 100;
