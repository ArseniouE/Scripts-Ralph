...
ELSE
	...
	e.jsondoc_->>'IdNumberOds' idnumberods,
	e.jsondoc_->>'IndustryPeerSector' industrypeersector,
	(e.jsondoc_->>'IsCustAbcFactors')::boolean iscustabcfactors,
	e.jsondoc_->>'IsCustLeasing' iscustleasing, 
	l3.jsondoc_->>'Value' iscustleasingval, 
	e.jsondoc_->>'IsCustLux' iscustlux, 
	l4.jsondoc_->>'Value' iscustluxval, 
	e.jsondoc_->>'IsNpl' isnpl,
	l5.jsondoc_->>'Value' isnplval,
...
(jsondoc_->>'OriginalModelGrade') originalmodelgrade, --added 1/8										
...
raise notice '% - Step abratingscenario - part a start', clock_timestamp();
	...
	select 
		...
		rs.jsondoc_ ->> 'OriginalGrade' originalgrade, --added 1/8										
		...
		(rs.jsondoc_->>'RevivalId') as revivalid, --add 20/5
