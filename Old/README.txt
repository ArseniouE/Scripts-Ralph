...
4) Tο olap_populate_sql_v23_Incremental που περιέχει ακριβώς τα ίδια στοιχεία με το olap_populate_sql_v23_Full  με λιγότερα σχόλια στο τέλος.
4) To αρχείο olap_populate_Incremental δημιουργεί μία function με το αρχείο olap_populate_sql_v23_Incremental.
5) To αρχείο olap_populate_uni δημιουργεί μία function με το αρχείο olap_populate_sql_uni_optimized.
6) Τα αρχεία με V2 περιέχουν την προσθήκη ResponsibleOfficer στη γέφυρα (abfactbanksystem).
