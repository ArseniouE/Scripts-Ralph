...
insert into olapts.abpdmodelbcategory
	SELECT 
		...
		WHERE 
			...
			AND GREATEST(mapinstance.updateddate_, mapinstance.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
...
raise notice '% Step abpdmodelbcategory - part b start', clock_timestamp();
	...
	CREATE TABLE olapts.abpdmodelbcategory AS
		...
		WHERE  
			GREATEST(mapinstance.updateddate_, mapinstance.createddate_) > (select COALESCE(max(asofdate), to_timestamp(0)) from olapts.refreshhistory where tablename = 'ABPDMODELBCATEGORY')
			AND GREATEST(mapinstance.updateddate_, mapinstance.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp AND mapinstance.t_ = 'PdModelBcategory'
		;
...
CREATE TABLE IF NOT EXISTS olapts.abpdmodelbcategoryflag AS
	...
	FROM madata.mapinstance
	where 
	GREATEST(mapinstance.updateddate_, mapinstance.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
	and mapinstance.t_ = 'PdModelBcategory';
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABPDMODELBCATEGORY' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABPDMODELBCATEGORYFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.abcorrectiveactionsmaster
	...
	WHERE	
		...
		AND GREATEST(correctiveactionsmaster.updateddate_, correctiveactionsmaster.createddate_)::timestamp <=current_setting('myvariables.popdate')::timestamp
...
where GREATEST(correctiveactionsmaster.updateddate_, correctiveactionsmaster.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
and correctiveactionsmaster.t_ = 'CorrectiveActionsMaster'
;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABCORRECTIVEACTIONSMASTER' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABCORRECTIVEACTIONSMASTERFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.abcorrectiveactions
	SELECT
		...
		(correctiveactions.jsondoc_ ->> 'FindingsDescription')::int4 FindingsDescriptions,
	...
	FROM madata.correctiveactions
		...
		left join madata.custom_lookup l3 on l3.t_ = 'FindingsDescriptions'  and l3.jsondoc_->>'Key'  = correctiveactions.jsondoc_ ->> 'FindingsDescription'		
	WHERE	
		...
		AND GREATEST(correctiveactions.updateddate_, correctiveactions.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
...
FROM madata.correctiveactions
where 
GREATEST(correctiveactions.updateddate_, correctiveactions.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
and correctiveactions.t_ = 'CorrectiveActions';
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABCORRECTIVEACTIONS' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABCORRECTIVEACTIONSFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABESFINDINGSCHARACTERIZATION' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABFINDINGSDESCRIPTIONS' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.abebadefinition
	...
	WHERE	
		...
		AND GREATEST(ebadefinition.updateddate_, ebadefinition.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
...
FROM madata.ebadefinition
where 
GREATEST(ebadefinition.updateddate_, ebadefinition.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
and ebadefinition.t_ = 'EbaDefinition';
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABEBADEFINITION' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABEBADEFINITIONFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABEBAYESNO' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABEBACOMMENT' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABYESNORM' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABEBATRIGGER' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.abespolicy
	...
	AND GREATEST(espolicy.updateddate_, espolicy.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
...
FROM madata.espolicy
where 
 GREATEST(espolicy.updateddate_, espolicy.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
and espolicy.t_ = 'EsPolicy'
;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABESPOLICY' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABESPOLICYFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABACTIONPLAN' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABMEDIUMHIGHSME' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABESLARGE' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABCHOOSEVIEW' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABRISKCATEGORIZATION' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABENSOCREDITCOMMITTEE' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABENSOPARAM' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
IF EXISTS (select from olapts.refreshhistory where tablename = 'ABLEVERAGEINDICATION') THEN
	...
	insert into olapts.ableverageindication
		...
		(leverageindication.jsondoc_ ->> 'CreditCommitteeDate')::timestamp AS creditCommitteeDate,	
		...
		AND GREATEST(leverageindication.updateddate_, leverageindication.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp	
...
CREATE TABLE IF NOT EXISTS olapts.ableverageindicationflag AS
	...
	,current_setting('myvariables.popdate')::timestamp as populateddate_
	FROM madata.leverageindication
	where GREATEST(leverageindication.updateddate_, leverageindication.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp	
	AND leverageindication.t_ = 'LeverageIndication';
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLEVERAGEINDICATION' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLEVERAGEINDICATIONFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLEVERAGEFINANCIALINDICATION' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLEVERAGEREASON' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLEVERAGETYPEREVIEW' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLUXEMBOURGRATINGS' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLUXEMBOURGRATINGSFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABORIGINATIONENTITY' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABREASONLUXEMBOURG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLUXEMBOURGRATING' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLUXEMBOURGRATING2' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLUXEMBOURGRATING3' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLONDONRATINGS' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABLONDONRATINGSFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
IF EXISTS (select from olapts.refreshhistory where tablename = 'ABTEIRESIASDATA') THEN
	...
	insert into olapts.abteiresiasdata
		...
		(case when (teiresiasdata.jsondoc_ ->>'TbScoreDate') like '%נל' 
			then to_char(to_date(replace(replace((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'נל','AM'),'לל','PM'),'dd/mm/yyyy'), 'yyyy-mm-dd')
			 when (strpos((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'לל') <> 0 or strpos((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'נל') <> 0)
			 	then to_char(to_date(replace(replace((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'נל','AM'),'לל','PM'),'dd/mm/yyyy'), 'yyyy-mm-dd')
			 when (strpos((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'לל') = 0 or strpos((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'נל') = 0)
			 	and (strpos((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'AM') = 0 and strpos((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'PM') = 0)
			    then to_char(to_date(replace(replace((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'נל','AM'),'לל','PM'),'dd/mm/yyyy'), 'yyyy-mm-dd')
				 else 
				 to_char(to_date(replace(replace((teiresiasdata.jsondoc_ ->>'TbScoreDate'),'נל','AM'),'לל','PM'),'mm/dd/yyyy'), 'yyyy-mm-dd')
		...
		WHERE 
			...
			AND GREATEST(teiresiasdata.updateddate_, teiresiasdata.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp	
...
FROM madata.teiresiasdata
where 
 GREATEST(teiresiasdata.updateddate_, teiresiasdata.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
and 
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABTEIRESIASDATA' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABTEIRESIASDATAFLAG' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.abutp
	...
	WHERE
		...
		AND GREATEST(utp.updateddate_, utp.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
		AND utp.t_ = 'Utp'
	;
...
FROM madata.utp
where 
GREATEST(utp.updateddate_, utp.createddate_)::timestamp <=current_setting('myvariables.popdate')::timestamp
and utp.t_ = 'Utp'
;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABUTP' tablename,current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABUTPFLAG' tablename,current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABUTPCREDITCOMMITTEE' tablename,current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.abspecialdelta
	...
	WHERE
		...
		AND GREATEST(specialdelta.updateddate_, specialdelta.createddate_)::timestamp <= current_setting('myvariables.popdate')::timestamp
...
FROM madata.specialdelta
where 
GREATEST(specialdelta.updateddate_, specialdelta.createddate_)::timestamp <=current_setting('myvariables.popdate')::timestamp
and specialdelta.t_ = 'SpecialDelta'
;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABSPECIALDELTA' tablename,current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABSPECIALDELTAFLAG' tablename,current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABSPECIALDELTARATINGREASON' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
...
insert into olapts.refreshhistory(tablename,asofdate,prevsuccessdate) select 'ABSPECIALNONSYSTEMICGRADE' tablename, current_setting('myvariables.popdate')::timestamp as  asofdate,varprevsuccessdate;
